...
public class FieldTreeNode extends KeedohMutableTreeNode implements CanPopUp,
        ActionListener {
    ...
    private void setupPopupMenu() {
        popupMenu.add(UIHelper.newJMenuItem("Edit", KeyEvent.VK_E, this,
                "__edit__"));
        popupMenu.add(UIHelper.newJMenuItem("Delete", KeyEvent.VK_D, this,
                "__delete__"));
