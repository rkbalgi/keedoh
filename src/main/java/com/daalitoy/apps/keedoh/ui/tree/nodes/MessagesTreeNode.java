...
public class MessagesTreeNode extends KeedohMutableTreeNode implements CanPopUp, ActionListener {
  ...
  private void setupPopupMenu() {
    ...
    pMenu.add(
        UIHelper.newJMenuItem("New Message", KeyEvent.VK_N, this, KeedohConstants.NEW_MESSAGE));
  }
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getActionCommand().equals(KeedohConstants.NEW_MESSAGE)) {
      SimpleTextInputDialog dialog = new SimpleTextInputDialog(getOwningTree(), "New Message");
