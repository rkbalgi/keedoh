...
public class ResponseMsgDialog extends JDialog {
    ...
    public ResponseMsgDialog(JComponent parent, MessageData rpMsgData) {
        ...
        setTitle("Response: " + rpMsgData.getMessage().getSpec().getSpecName() + "//" + rpMsgData.getMessage().getMsgName());
    ...
    private void initComponents() {
        ...
        responseMsgDataTable.setModel(new EditableMessageTableModel(responseMsgData.getMessage(), false));
        ...
        JButton btn = UIHelper.newButton("OK", "", (event) -> {
                    this.dispose();
                }
        );
        panel.add(btn);
