...
public class SpecTreeNode extends KeedohMutableTreeNode implements CanPopUp, ActionListener {
  ...
  private void setupPopupMenu() {
    JMenuItem item = UIHelper.newJMenuItem("Edit", KeyEvent.VK_E, this, "__edit__");
    popup.add(item);
  }
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if (event.getActionCommand().equals("__edit__")) {
      JInternalFrame frame = new NewMessageSpecificationInternalFrame(spec);
