...
public class Bit {
  ...
  private static final byte[] LOOKUP = {(byte) 0x80, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0x01};
  private BitSet bitSet = new BitSet(129);

  public Bit(byte[] data) {
    Preconditions.checkArgument((data != null) && ((data.length == 8) || (data.length == 16)));
    int n = 1;
    for (byte b : data) {
  ...
  public static void main(String[] args) {
    Bit b = new Bit(new byte[] {0x22, 0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03});

    Preconditions.checkArgument(b.isOn(3) && b.isOn(7) && b.isOn(11) & b.isOn(15) && b.isOn(64));
    b.setOn(8);
    b.setOn(62);
    b.setOn(128);
