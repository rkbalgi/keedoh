...
public class MessageStore {
  ...
  private static Map<MessageData, MessageData> clientMsgMap = Maps.newHashMap();
  private static List<MessageData> clientMsgList = Lists.newArrayList();

  private static Map<MessageData, MessageData> serverMsgMap = Maps.newHashMap();
  private static List<MessageData> serverMsgList = Lists.newArrayList();

  public static synchronized MessageData logClient(MessageData rqMsgData, MessageData rpMsgData) {
  ...
  public static synchronized void logServer(MessageData rqMsgData, MessageData rpMsgData) {
    // MessageData mData = (MessageData) rqMsgData.clone();
