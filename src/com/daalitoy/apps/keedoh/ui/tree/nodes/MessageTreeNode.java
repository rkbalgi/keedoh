...
public class MessageTreeNode extends KeedohMutableTreeNode implements CanPopUp,
		ActionListener {
	...
	public void init() {
		// add children
		RequestFragmentTreeNode rqFragNode = new RequestFragmentTreeNode(
				msg.getRequestFragment());
		addToSelf(rqFragNode);
		rqFragNode.init();
		ResponseFragmentTreeNode rpFragNode = new ResponseFragmentTreeNode(
				msg.getResponseFragment());
	...
	private void setupPopupMenu() {
		popupMenu.add(UIHelper.newJMenuItem("Save", KeyEvent.VK_S,
				this, "__save__"));
		popupMenu.add(UIHelper.newJMenuItem("Delete", KeyEvent.VK_D,
				this, "__delete__"));
