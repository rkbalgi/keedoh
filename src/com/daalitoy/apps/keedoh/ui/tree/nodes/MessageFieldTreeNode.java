...
public class MessageFieldTreeNode extends KeedohMutableTreeNode implements
	...
	public MessageFieldTreeNode(MessageFragment fragment, Field field) {
		super(field);
		this.field = field;
	...
	private void setupPopupMenu() {
		popupMenu.add(UIHelper.newJMenuItem("Move Up", KeyEvent.VK_U,
				this, "__up__"));
		popupMenu.add(UIHelper.newJMenuItem("Move Down", KeyEvent.VK_D,
				this, "__down__"));
		popupMenu.add(UIHelper.newJMenuItem("Remove", KeyEvent.VK_R,
				this, "__remove__"));
	...
	public void actionPerformed(ActionEvent arg0) {
		if (arg0.getActionCommand().equals("__up__")) {
			...
			MessageFieldTreeNode prevNode = (MessageFieldTreeNode) getParent()
					.getChildAt(thisNode - 1);
			removeNode(prevNode);
			...
			MessageFieldTreeNode nextNode = (MessageFieldTreeNode) getParent()
					.getChildAt(thisNode + 1);
			removeNode(nextNode);
