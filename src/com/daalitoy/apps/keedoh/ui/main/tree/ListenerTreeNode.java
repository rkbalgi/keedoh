...
public class ListenerTreeNode extends KeedohMutableTreeNode implements
	...
	public ListenerTreeNode(ListenerConfig config) {
		super(config);
		setupPopupMenu();
	}
	...
	private void setupPopupMenu() {
		...
		pMenu.add(UIHelper
				.newJMenuItem("Edit", KeyEvent.VK_E, this, "__edit__"));
		pMenu.add(UIHelper.newJMenuItem("Start", KeyEvent.VK_S, this,
				"__start__"));
		pMenu.add(UIHelper.newJMenuItem("Stop", KeyEvent.VK_P, this,
				"__shutdown__"));
	...
	public void actionPerformed(ActionEvent arg0) {
		if (arg0.getActionCommand().equals("__edit__")) {
			ListenerConfig config = new ListenerConfigDialog(KeedohMainFrame.getDesktopPane(),
					(ListenerConfig) getUserObject()).showDialog();
			ListenerConfig.update(config);
