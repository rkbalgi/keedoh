...
public class ConnectorTreeNode extends KeedohMutableTreeNode implements
	...
	public ConnectorTreeNode(ConnectorConfig config) {
		super(config);
		setupPopupMenu();
	}
	...
	private void setupPopupMenu() {
		...
		pMenu.addSeparator();
		pMenu.add(UIHelper.newJMenuItem("Connect", KeyEvent.VK_C, this,
				"__connect__"));
		pMenu.add(UIHelper.newJMenuItem("Disconnect", KeyEvent.VK_D, this,
				"__disconnect__"));
	...
	public void actionPerformed(ActionEvent arg0) {
		if (arg0.getActionCommand().equals("__edit__")) {
			ConnectorConfig config = new ConnectorConfigDialog(getOwningTree(),
					(ConnectorConfig) getUserObject()).showDialog();
			ConnectorConfig.update(config);
